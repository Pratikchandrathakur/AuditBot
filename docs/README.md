...
#### Day 2: SSH Hardening
- [SSH Hardening - Windows Server](./day-2-ssh-hardening-windows-server.md)

#### Day 5: Firewalls
- [Firewalls - Linux/Ubuntu (UFW)](./day-5-firewalls-ufw.md)
- [Firewalls - Windows Server](./day-5-firewalls-windows-server.md)
...
- [Git Pre-Commit Hooks - Secret Scanning](./day-6-git-security-hooks.md)
